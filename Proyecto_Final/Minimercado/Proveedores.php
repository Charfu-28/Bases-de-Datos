					...
					<tbody>
						<?php while ($row = $resultado ->fetch_array(MYSQLI_ASSOC))	{ ?>
							<tr>
								...
								<td><a href="Modificar_Proveedor.php?Codigo_Proveedor=<?php echo $row["Codigo_Proveedor"]; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
								<td><a href="#" data-href="Eliminar_Proveedor.php?Codigo_Proveedor=<?php echo $row["Codigo_Proveedor"]; ?>" data-toggle="modal" data-target="#confirm-delete"><span class="glyphicon glyphicon-trash"></span></a></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
